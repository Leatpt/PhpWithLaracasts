...
<div class="min-h-full">
        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <a href="/ourMission.php" class="bg-gray-900 text-white rounded-md px-3 py-2 text-sm font-medium">Our Mission</a>
            </div>
          </div>
        </div>
        <div class="hidden md:block">
  ...
  <header class="bg-white shadow">
    <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
      <h1 class="text-3xl font-bold tracking-tight text-gray-900">Learn more</h1>
    </div>
  </header>
  <main>
    <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
      <p>Where from and where to</p>
    </div>
  </main>
</div>
